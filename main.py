...
def main(args):
    args.masks = False
    assert args.dataset_file in ["rsvg", "opt_rsvg"]
    ...
    if args.dataset_file != "opt_rsvg":
        data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
                                   collate_fn=utils.collate_fn, num_workers=args.num_workers,
                                   pin_memory=True)
    else:
        data_loader_train = DataLoader(dataset_train, batch_sampler=batch_sampler_train,
                                   collate_fn=utils.collate_fn_new, num_workers=args.num_workers,
                                   pin_memory=True)
    ...
    for epoch in range(args.start_epoch, args.epochs):
        ...
        log_stats = {'current_time': datetime.datetime.now().strftime("%Y-%m-%d %H:%M:%S"),
...
if __name__ == '__main__':
    parser = argparse.ArgumentParser('ReferFormer pretrain training and evaluation script', parents=[configs.get_args_parser()])
