...
class HungarianMatcher(nn.Module):
    ...
    def __init__(self, cost_class: float = 1, cost_bbox: float = 1, cost_giou: float = 1, cost_preiou: float = 1, num_classes: int = 1):
        """Creates the matcher
        ...
        self.cost_preiou = cost_preiou
        self.num_classes = num_classes
        assert cost_class != 0 or cost_bbox != 0 or cost_giou != 0 or cost_preiou != 0 , "all costs cant be 0"
    ...
    def forward(self, outputs, targets):
        ...
        for i in range(bs): 
            ...
            for t in range(nf):
                ...
                out_pre_bob_split = out_pre_bob[t]
            ...
            # Final cost matrix
            C = self.cost_class * cost_class + self.cost_bbox * cost_bbox + self.cost_giou * cost_giou + self.cost_preiou * cost_pre
...
def build_matcher(args):
    ...
    return HungarianMatcher(cost_class=args.set_cost_class, 
                            ...
                            cost_preiou=args.set_cost_preiou,
